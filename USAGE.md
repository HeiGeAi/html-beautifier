...
- **商务专业** - 天空蓝/薄荷绿为主，稳重可靠
- **活力创意** - 多色搭配，年轻活泼
- **简约优雅** - 克制配色、低装饰密度，留白只做模块边界，仍遵守密度基准
...
如需动画，建议复制生成结果后在独立版本中自行扩展；正式版 skill 输出、官方示例和发布资产默认保持无动画。
...
| 内容特征 | 推荐模式 | 原因 |
|---------|---------|------|
| 长篇分析文章 | Editorial | 连续阅读体验，章节清晰 |
| 多维度数据 | Dashboard | 一屏看全，信息密度高 |
| 单一主题海报 | Single | 视觉冲击力强 |
| 方案展示/产品介绍 | Editorial | 长滚动叙事，适合详细内容 |
